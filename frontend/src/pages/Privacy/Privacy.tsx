...
const Privacy = () => (
  <>
    ...
    <PageContainer>
      ...
      <p>This SERVICE is provided by Maxwell Reid at no cost and is intended for use as is.This page is used to inform visitors regarding the policies of the collection, use, and disclosure of Personal Information if using the Service.</p>
      ...
      <ul>
        ...
        <li><a href="https://docs.github.com/en/site-policy/privacy-policies/github-privacy-statement">GitHub</a></li>
      </ul>
      ...
      <p>If you would like to delete your data from the service, navigate to the settings panel whilst log in and select "Delete Account".</p>
